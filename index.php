    ...
    <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
      <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
        <div class="footer-logo-wrapper text-center text-sm-start">
          <a href="#!">
            <img src="./assets/logo.png" alt=" Logo" width="175" height="57">
          </a>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-xl-6 order-2 order-xl-1">
        <ul class="nav justify-content-center">
          <li class="nav-item">
            <a class="nav-link link-secondary px-2 px-md-3" href="#!">Főoldal</a>
          </li>
          <li class="nav-item">
            <a class="nav-link link-secondary px-2 px-md-3" href="#!">Galéria</a>
          </li>
          <li class="nav-item">
            <a class="nav-link link-secondary px-2 px-md-3" href="#!">Blog</a>
          </li>
          <li class="nav-item">
            <a class="nav-link link-secondary px-2 px-md-3" href="#!">Kapcsolat</a>
          </li>
        </ul>
      </div>
      ...
      <div class="col-xs-12 col-sm-6 col-xl-3 order-1 order-xl-2">
        <ul class="nav justify-content-center justify-content-sm-end">
          ...
          <li class="nav-item">
            <a class="nav-link link-dark px-3" href="https://www.youtube.com/">
          ...
          <li class="nav-item">
            <a class="nav-link link-dark px-3" href="https://www.twitter.com/">
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="credits text-secondary text-center mt-2 fs-7">
          Készült <a href="https://github.com/" class="link-secondary text-decoration-none">általam</a> kód a <span class="text-primary">github;</span>
        </div>
      </div>
    </div>
  </div>
